        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Растаниҳо ҳаёти шуморо бо ҳадди ақал ва хушбахтона дӯст медоранд, ки растаниҳоро бештар дӯст медоранд ва аз ҳаёт лаззат мебаранд",
                style: TextStyle(
                  fontSize: 12,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: const Text("Ба сабат андоз"),
                        ),
                      )
                    ],
                  )
